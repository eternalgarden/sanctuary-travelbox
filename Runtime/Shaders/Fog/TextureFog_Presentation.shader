Shader "PowderBox/TextureFog_Presentation"
{
    Properties
    {
        ...
        [Header(Debug), Space]
        [Toggle(DRAW_DEPTH)] _DrawDepth("Debug draw depth", Float) = 0
    }
    SubShader
    {
        // We don't need culling
        // We don't want to draw do depth buffer
        Cull Off ZWrite Off
        ...
        Pass
        {
            ...
            #pragma shader_feature DRAW_DEPTH
            ...
            float _FogPower, _BaseFog, _FogIntensity;
            float _FogMax, _FogMin;
